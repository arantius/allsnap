...
BEGIN_SREG_MAP()
    ...
    SREG_ENTRY(REGT_INT,  setCropBottom,      getCropBottom,     "crop_bottom")
    SREG_ENTRY(REGT_INT,  setCropLeft,        getCropLeft,       "crop_left")
    SREG_ENTRY(REGT_INT,  setCropRight,       getCropRight,      "crop_right")
    SREG_ENTRY(REGT_BOOL, setCroppingEnabled, isCroppingEnabled, "is_cropping_enabled")
